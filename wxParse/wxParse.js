...
wx.getSystemInfo({
    ...
    wxParse: function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "wxParseData", r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "html", n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : '<div class="color:red;">数据不能为空</div>', s = arguments[3], l = arguments[4], g = s, h = {};
        if ("html" == r) h = o.default.html2json(n, e); else if ("md" == r || "markdown" == r) {
            var m = new d.default.Converter().makeHtml(n);
            h = o.default.html2json(m, e);
        }
        h.view = {}, h.view.imagePadding = 0, void 0 !== l && (h.view.imagePadding = l);
        var u = {};
        u[e] = h, g.setData(t({}, e, {})), g.setData(u), g.wxParseImgLoad = i, g.wxParseImgTap = a;
    },
